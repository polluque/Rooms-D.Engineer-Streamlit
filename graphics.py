...
# FUNCIÓN PARA GENERAR LA TABLA DE COMPAÑEROS (generar tala de compatibilidad)
def generar_tabla_compatibilidad(resultado):
    # Cambiar el nombre de la columna 'index' por 'ATRIBUTO' y ajustar el ancho de las columnas
...
#Función: Obtener IDs de inquilinos
